...
Option 2: Generate FASTA files with sequence alignments of given lengths L1...Ld  and given tree in a newick format. **Note that in this case, lenghts sequences are preceeded by an L**
